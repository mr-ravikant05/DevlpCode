...
(function () {
  ...
  if (form) {
    form.addEventListener("submit", (e) => {
      ...
      if (n.length < 2) return showToast("Check your name", "Please enter a valid name (min 2 characters).");
      if (!isEmail(em)) return showToast("Invalid email", "Please enter a valid email address.");
      if (!tp) return showToast("Select a topic", "Please choose what you need help with.");
      if (msg.length < 12) return showToast("Message too short", "Please write at least 12 characters.");
...
// Footer year (no inline JS needed)
